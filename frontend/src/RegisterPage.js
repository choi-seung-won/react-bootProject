        ...
        this.fnSignInsert = async (e) => {
            ...
            try {
                ...
                if (response.status == '200') {
                    ...
                    this.sweetalert('작업중 오류가 발생하였습니다.', response.status, 'error', '닫기');
                }
                        ...
                        <form method="post" name="frm">
                            <div className="re1_wrap">
                                ...
                                <div className="btn_confirm">
                                    <div className="btn btn-primary" style={{ textalign: 'center', position: 'center', width: '30%' }}
